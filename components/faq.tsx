...
export function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "We limit our demo batches to 15-20 students to ensure personalized attention and interaction.",
    },
    {
  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-background-feature">
