...
export function RegistrationForm({ onSubmit }: RegistrationFormProps) {
  ...
  const handlePhotoCapture = () => {
    ...
    const randomPhoto = `/placeholder.svg?height=200&width=200&text=Photo`
  ...
  const handleMobileOTPSuccess = () => {
    // All verification complete, proceed to next step
    onSubmit({
      ...formValues,
      photo: photoPreview,
    })
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>We'll send you an OTP to verify this email.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>We'll send you an OTP to verify this number.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
